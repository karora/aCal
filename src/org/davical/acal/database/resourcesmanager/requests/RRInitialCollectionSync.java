...
import org.davical.acal.service.HomeSetsUpdate;
import org.davical.acal.service.ServiceJob;
import org.davical.acal.service.SyncCollectionContents;
import org.davical.acal.service.SynchronisationJobs;
...
*/
	...
	public void process(WriteableResourceTableManager processor) throws ResourceProcessingException {
		...
		try {
			...
			requestor = AcalRequestor.fromServerValues(serverData, processor.getContext());
