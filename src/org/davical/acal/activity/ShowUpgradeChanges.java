...
public class ShowUpgradeChanges extends AcalAppCompatActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        upNotes.append("</ul>");
        upNotes.append("<li>" + getString(R.string.aCal_Website, "<a href=\"http://wiki.davical.org/aCal\">wiki.davical.org/aCal</a>") + "</li>");
        upNotes.append("<li>" + getString(R.string.aCal_IRC_Channel) + "</li>");
        upNotes.append("<li>" + getString(R.string.aCal_Mailing_Lists) + "</li>");
        upNotes.append("<li>aCal is developed by Andrew McMillan and others.</li>");
        upNotes.append("</ul>");
